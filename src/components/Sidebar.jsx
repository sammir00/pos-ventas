...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col min-h-screen transition-all select-none border-r border-slate-800/80 shadow-[4px_0_24px_rgba(0,0,0,0.02)] z-10">
